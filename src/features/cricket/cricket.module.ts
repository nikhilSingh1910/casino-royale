...
@Module({
  ...
  providers: [CricketRepo, FeedIngestService, MarketRepo, MarketService, BetRepo, PlacementService, SettlementService, LiveTicker, LiveEvents, CricketJobs, BetHistoryService, LeaderboardService],
